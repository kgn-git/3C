...
This repo contains only the runtime-installable surface of 3C v1.7.1: built `dist/`, deployable `templates/`, `framework.json`, and the deployment branding template.
...
```bash
npm install git+https://github.com/kgn-git/3C#v1.7.1
```
